...
# title      Catppuccin                                               +
# version    1.0.0                                                    +
# repository https://github.com/amateur-hacker/catppuccin-tmux        +
# author     amateur-hacker                                           +
# email      amateurhacker2004@gmail.com                              +
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
terminal_icon="$(echo "$TMUX_VARS" | grep '@catppuccin-tmux_terminal_icon' | cut -d" " -f2)"
active_terminal_icon="$(echo "$TMUX_VARS" | grep '@catppuccin-tmux_active_terminal_icon' | cut -d" " -f2)"
window_tidy="$(echo "$TMUX_VARS" | grep '@catppuccin-tmux_window_tidy_icons' | cut -d" " -f2)"
